...
abstract class Account implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\SciMS\\Models\\Map\\AccountTableMap';
    ...
    public function setUid($v)
    {
        ...
        if ($this->uid !== $v) {
            $this->uid = $v;
            $this->modifiedColumns[AccountTableMap::COL_UID] = true;
        }
    ...
    public function setFirstName($v)
    {
        ...
        if ($this->first_name !== $v) {
            $this->first_name = $v;
            $this->modifiedColumns[AccountTableMap::COL_FIRST_NAME] = true;
        }
    ...
    public function setLastName($v)
    {
        ...
        if ($this->last_name !== $v) {
            $this->last_name = $v;
            $this->modifiedColumns[AccountTableMap::COL_LAST_NAME] = true;
        }
    ...
    public function setBiography($v)
    {
        ...
        if ($this->biography !== $v) {
            $this->biography = $v;
            $this->modifiedColumns[AccountTableMap::COL_BIOGRAPHY] = true;
        }
    ...
    public function setToken($v)
    {
        ...
        if ($this->token !== $v) {
            $this->token = $v;
            $this->modifiedColumns[AccountTableMap::COL_TOKEN] = true;
        }
    ...
    public function setTokenExpiration($v)
    {
        ...
        if ($this->token_expiration !== $v) {
            ...
            $this->modifiedColumns[AccountTableMap::COL_TOKEN_EXPIRATION] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : AccountTableMap::translateFieldName('Uid', TableMap::TYPE_PHPNAME, $indexType)];
            $this->uid = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : AccountTableMap::translateFieldName('Email', TableMap::TYPE_PHPNAME, $indexType)];
            $this->email = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : AccountTableMap::translateFieldName('FirstName', TableMap::TYPE_PHPNAME, $indexType)];
            $this->first_name = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : AccountTableMap::translateFieldName('LastName', TableMap::TYPE_PHPNAME, $indexType)];
            $this->last_name = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 5 + $startcol : AccountTableMap::translateFieldName('Biography', TableMap::TYPE_PHPNAME, $indexType)];
            $this->biography = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 6 + $startcol : AccountTableMap::translateFieldName('Password', TableMap::TYPE_PHPNAME, $indexType)];
            $this->password = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 7 + $startcol : AccountTableMap::translateFieldName('Token', TableMap::TYPE_PHPNAME, $indexType)];
        ...
        if (!$this->alreadyInSave) {
            ...
            if ($this->articleViewsScheduledForDeletion !== null) {
                if (!$this->articleViewsScheduledForDeletion->isEmpty()) {
                    foreach ($this->articleViewsScheduledForDeletion as $articleView) {
                        // need to save related object because we set the relation to null
                        $articleView->save($con);
                    }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(AccountTableMap::COL_UID)) {
            $modifiedColumns[':p' . $index++]  = 'uid';
        }
        if ($this->isColumnModified(AccountTableMap::COL_EMAIL)) {
            $modifiedColumns[':p' . $index++]  = 'email';
        }
        if ($this->isColumnModified(AccountTableMap::COL_FIRST_NAME)) {
            $modifiedColumns[':p' . $index++]  = 'first_name';
        }
        if ($this->isColumnModified(AccountTableMap::COL_LAST_NAME)) {
            $modifiedColumns[':p' . $index++]  = 'last_name';
        }
        if ($this->isColumnModified(AccountTableMap::COL_BIOGRAPHY)) {
            $modifiedColumns[':p' . $index++]  = 'biography';
        }
        if ($this->isColumnModified(AccountTableMap::COL_PASSWORD)) {
            $modifiedColumns[':p' . $index++]  = 'password';
        }
        if ($this->isColumnModified(AccountTableMap::COL_TOKEN)) {
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\SciMS\Models\Account
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\SciMS\Models\Account The current object, for fluid interface
     */
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(AccountTableMap::COL_UID)) {
            $criteria->add(AccountTableMap::COL_UID, $this->uid);
        }
        if ($this->isColumnModified(AccountTableMap::COL_EMAIL)) {
            $criteria->add(AccountTableMap::COL_EMAIL, $this->email);
        }
        if ($this->isColumnModified(AccountTableMap::COL_FIRST_NAME)) {
            $criteria->add(AccountTableMap::COL_FIRST_NAME, $this->first_name);
        }
        if ($this->isColumnModified(AccountTableMap::COL_LAST_NAME)) {
            $criteria->add(AccountTableMap::COL_LAST_NAME, $this->last_name);
        }
        if ($this->isColumnModified(AccountTableMap::COL_BIOGRAPHY)) {
            $criteria->add(AccountTableMap::COL_BIOGRAPHY, $this->biography);
        }
        if ($this->isColumnModified(AccountTableMap::COL_PASSWORD)) {
            $criteria->add(AccountTableMap::COL_PASSWORD, $this->password);
        }
        if ($this->isColumnModified(AccountTableMap::COL_TOKEN)) {
            $criteria->add(AccountTableMap::COL_TOKEN, $this->token);
        }
        if ($this->isColumnModified(AccountTableMap::COL_TOKEN_EXPIRATION)) {
     ...
     * objects.
     *
     * @param      object $copyObj An object of \SciMS\Models\Account (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \SciMS\Models\Account Clone of current object.
     * @throws PropelException
     */
    ...
    public function setArticles(Collection $articles, ConnectionInterface $con = null)
    {
        ...
        foreach ($articlesToDelete as $articleRemoved) {
            $articleRemoved->setAccount(null);
        }
    ...
    public function setArticleViews(Collection $articleViews, ConnectionInterface $con = null)
    {
        ...
        foreach ($articleViewsToDelete as $articleViewRemoved) {
            $articleViewRemoved->setAccount(null);
        }
    ...
    public function removeArticleView(ChildArticleView $articleView)
    {
        if ($this->getArticleViews()->contains($articleView)) {
            ...
            $this->articleViewsScheduledForDeletion[]= $articleView;
            $articleView->setAccount(null);
        }
     ...
     * @return ObjectCollection|ChildArticleView[] List of ChildArticleView objects
     */
    public function getArticleViewsJoinArticle(Criteria $criteria = null, ConnectionInterface $con = null, $joinBehavior = Criteria::LEFT_JOIN)
    {
        $query = ChildArticleViewQuery::create(null, $criteria);
    ...
    public function setHighlightedArticles(Collection $highlightedArticles, ConnectionInterface $con = null)
    {
        ...
        foreach ($highlightedArticlesToDelete as $highlightedArticleRemoved) {
            $highlightedArticleRemoved->setaccount(null);
        }
    ...
    protected function doAddHighlightedArticle(ChildHighlightedArticle $highlightedArticle)
    {
        ...
        $highlightedArticle->setaccount($this);
    }
    ...
    public function removeHighlightedArticle(ChildHighlightedArticle $highlightedArticle)
    {
        if ($this->getHighlightedArticles()->contains($highlightedArticle)) {
            ...
            $highlightedArticle->setaccount(null);
        }
