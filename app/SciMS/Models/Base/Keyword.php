...
abstract class Keyword implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\SciMS\\Models\\Map\\KeywordTableMap';
    ...
    /**
     * Initializes internal state of SciMS\Models\Base\Keyword object.
     */
     ...
     *
     * @return $this|Keyword The current object, for fluid interface
     */
     ...
     * @return $this|\SciMS\Models\Keyword The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[KeywordTableMap::COL_ID] = true;
        }
    ...
    public function setArticleId($v)
    {
        ...
        if ($this->article_id !== $v) {
            $this->article_id = $v;
            $this->modifiedColumns[KeywordTableMap::COL_ARTICLE_ID] = true;
        }
    ...
    public function setTitle($v)
    {
        ...
        if ($this->title !== $v) {
            $this->title = $v;
            $this->modifiedColumns[KeywordTableMap::COL_TITLE] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : KeywordTableMap::translateFieldName('ArticleId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->article_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : KeywordTableMap::translateFieldName('Title', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 3; // 3 = KeywordTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\SciMS\\Models\\Keyword'), 0, $e);
        }
    }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if (null === $this->id) {
            try {
                $dataFetcher = $con->query("SELECT nextval('keyword_id_seq')");
        ...
        if ($this->isColumnModified(KeywordTableMap::COL_ID)) {
            $modifiedColumns[':p' . $index++]  = 'id';
        }
        if ($this->isColumnModified(KeywordTableMap::COL_ARTICLE_ID)) {
            $modifiedColumns[':p' . $index++]  = 'article_id';
        }
        if ($this->isColumnModified(KeywordTableMap::COL_TITLE)) {
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['Keyword'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['Keyword'][$this->hashCode()] = true;
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\SciMS\Models\Keyword
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\SciMS\Models\Keyword The current object, for fluid interface
     */
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(KeywordTableMap::COL_ID)) {
            $criteria->add(KeywordTableMap::COL_ID, $this->id);
        }
        if ($this->isColumnModified(KeywordTableMap::COL_ARTICLE_ID)) {
            $criteria->add(KeywordTableMap::COL_ARTICLE_ID, $this->article_id);
        }
        if ($this->isColumnModified(KeywordTableMap::COL_TITLE)) {
            $criteria->add(KeywordTableMap::COL_TITLE, $this->title);
        }
    ...
    {
        $criteria = ChildKeywordQuery::create();
        $criteria->add(KeywordTableMap::COL_ID, $this->id);
     ...
     * objects.
     *
     * @param      object $copyObj An object of \SciMS\Models\Keyword (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \SciMS\Models\Keyword Clone of current object.
     * @throws PropelException
     */
    ...
    public function getArticle(ConnectionInterface $con = null)
    {
        if ($this->aArticle === null && ($this->article_id !== null)) {
            ...
            /* The following can be used additionally to
                ...
                $this->aArticle->addKeywords($this);
             */
        }
    ...
    {
        if (null !== $this->aArticle) {
            $this->aArticle->removeKeyword($this);
        }
        $this->id = null;
