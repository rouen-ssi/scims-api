...
/**
 * Base class that represents a row from the 'highlighted_article' table.
 *
 *
 *
 * @package    propel.generator.SciMS.Models.Base
 */
abstract class HighlightedArticle implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\SciMS\\Models\\Map\\HighlightedArticleTableMap';
    ...
    /**
     * Initializes internal state of SciMS\Models\Base\HighlightedArticle object.
     */
    ...
    /**
     * Compares this with another <code>HighlightedArticle</code> instance.  If
     * <code>obj</code> is an instance of <code>HighlightedArticle</code>, delegates to
     * <code>equals(HighlightedArticle)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|HighlightedArticle The current object, for fluid interface
     */
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            return $startcol + 2; // 2 = HighlightedArticleTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\SciMS\\Models\\HighlightedArticle'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildHighlightedArticleQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see HighlightedArticle::setDeleted()
     * @see HighlightedArticle::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildHighlightedArticleQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                HighlightedArticleTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        $sql = sprintf(
            'INSERT INTO highlighted_article (%s) VALUES (%s)',
    ...
    {
        $pos = HighlightedArticleTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['HighlightedArticle'][$this->hashCode()])) {
            return '*RECURSION*';
        }
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\SciMS\Models\HighlightedArticle
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\SciMS\Models\HighlightedArticle The current object, for fluid interface
     */
     ...
     * objects.
     *
     * @param      object $copyObj An object of \SciMS\Models\HighlightedArticle (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \SciMS\Models\HighlightedArticle Clone of current object.
     * @throws PropelException
     */
    ...
    {
        return (string) $this->exportTo(HighlightedArticleTableMap::DEFAULT_STRING_FORMAT);
    }
