...
/**
 * Base class that represents a row from the 'article_view' table.
 *
 *
 *
 * @package    propel.generator.SciMS.Models.Base
 */
abstract class ArticleView implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\SciMS\\Models\\Map\\ArticleViewTableMap';
    ...
    /**
     * Initializes internal state of SciMS\Models\Base\ArticleView object.
     */
    ...
    /**
     * Compares this with another <code>ArticleView</code> instance.  If
     * <code>obj</code> is an instance of <code>ArticleView</code>, delegates to
     * <code>equals(ArticleView)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|ArticleView The current object, for fluid interface
     */
     ...
     * @return $this|\SciMS\Models\ArticleView The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[ArticleViewTableMap::COL_ID] = true;
        }
    ...
    public function setArticleId($v)
    {
        ...
        if ($this->article_id !== $v) {
            $this->article_id = $v;
            $this->modifiedColumns[ArticleViewTableMap::COL_ARTICLE_ID] = true;
        }
    ...
    public function setAccountId($v)
    {
        ...
        if ($this->account_id !== $v) {
            $this->account_id = $v;
            $this->modifiedColumns[ArticleViewTableMap::COL_ACCOUNT_ID] = true;
        }
    ...
    public function setDate($v)
    {
        ...
        if ($this->date !== $v) {
            $this->date = $v;
            $this->modifiedColumns[ArticleViewTableMap::COL_DATE] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : ArticleViewTableMap::translateFieldName('Id', TableMap::TYPE_PHPNAME, $indexType)];
            $this->id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : ArticleViewTableMap::translateFieldName('ArticleId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->article_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : ArticleViewTableMap::translateFieldName('AccountId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->account_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : ArticleViewTableMap::translateFieldName('Date', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 4; // 4 = ArticleViewTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\SciMS\\Models\\ArticleView'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildArticleViewQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see ArticleView::setDeleted()
     * @see ArticleView::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildArticleViewQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                ArticleViewTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if (null === $this->id) {
            try {
                $dataFetcher = $con->query("SELECT nextval('article_view_id_seq')");
        ...
        if ($this->isColumnModified(ArticleViewTableMap::COL_ID)) {
            $modifiedColumns[':p' . $index++]  = 'id';
        }
        if ($this->isColumnModified(ArticleViewTableMap::COL_ARTICLE_ID)) {
            $modifiedColumns[':p' . $index++]  = 'article_id';
        }
        if ($this->isColumnModified(ArticleViewTableMap::COL_ACCOUNT_ID)) {
            $modifiedColumns[':p' . $index++]  = 'account_id';
        }
        if ($this->isColumnModified(ArticleViewTableMap::COL_DATE)) {
            $modifiedColumns[':p' . $index++]  = 'date';
        }

        $sql = sprintf(
            'INSERT INTO article_view (%s) VALUES (%s)',
    ...
    {
        $pos = ArticleViewTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['ArticleView'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['ArticleView'][$this->hashCode()] = true;
        $keys = ArticleViewTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\SciMS\Models\ArticleView
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\SciMS\Models\ArticleView The current object, for fluid interface
     */
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(ArticleViewTableMap::COL_ID)) {
            $criteria->add(ArticleViewTableMap::COL_ID, $this->id);
        }
        if ($this->isColumnModified(ArticleViewTableMap::COL_ARTICLE_ID)) {
            $criteria->add(ArticleViewTableMap::COL_ARTICLE_ID, $this->article_id);
        }
        if ($this->isColumnModified(ArticleViewTableMap::COL_ACCOUNT_ID)) {
            $criteria->add(ArticleViewTableMap::COL_ACCOUNT_ID, $this->account_id);
        }
        if ($this->isColumnModified(ArticleViewTableMap::COL_DATE)) {
            $criteria->add(ArticleViewTableMap::COL_DATE, $this->date);
        }
    ...
    {
        $criteria = ChildArticleViewQuery::create();
        $criteria->add(ArticleViewTableMap::COL_ID, $this->id);
     ...
     * objects.
     *
     * @param      object $copyObj An object of \SciMS\Models\ArticleView (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \SciMS\Models\ArticleView Clone of current object.
     * @throws PropelException
     */
    ...
    public function getArticle(ConnectionInterface $con = null)
    {
        if ($this->aArticle === null && ($this->article_id !== null)) {
            ...
            /* The following can be used additionally to
                ...
                $this->aArticle->addArticleViews($this);
             */
        }
    ...
    public function getAccount(ConnectionInterface $con = null)
    {
        if ($this->aAccount === null && ($this->account_id !== null)) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aAccount->addArticleViews($this);
             */
        }
    ...
    {
        if (null !== $this->aArticle) {
            $this->aArticle->removeArticleView($this);
        }
        if (null !== $this->aAccount) {
            $this->aAccount->removeArticleView($this);
        }
        $this->id = null;
    ...
    {
        return (string) $this->exportTo(ArticleViewTableMap::DEFAULT_STRING_FORMAT);
    }
