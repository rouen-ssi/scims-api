...
class UserTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'SciMS.Models.Map.UserTableMap';
     ...
     */
    const OM_CLASS = '\\SciMS\\Models\\User';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'SciMS.Models.User';
     ...
     */
    const COL_TOKEN_EXPIRATION = 'user.token_expiration';
  ...
  array (
     ...
     * and findPk*() calls.
     *
     * @param \SciMS\Models\User $obj A \SciMS\Models\User object.
     ...
     *
     * @param mixed $value A \SciMS\Models\User object or a primary key value.
     */
    public static function removeInstanceFromPool($value)
    {
        if (Propel::isInstancePoolingEnabled() && null !== $value) {
            if (is_object($value) && $value instanceof \SciMS\Models\User) {
                ...
                $e = new PropelException("Invalid value passed to removeInstanceFromPool().  Expected primary key or \SciMS\Models\User object; got " . (is_object($value) ? get_class($value) . ' object.' : var_export($value, true)));
                throw $e;
            }
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \SciMS\Models\User) { // it's a model object
            ...
            foreach ($values as $value) {
                ...
                $criterion->addAnd($criteria->getNewCriterion(UserTableMap::COL_EMAIL, $value[1]));
